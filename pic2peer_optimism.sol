...
contract pic2peer {
    ...
    OptimisticOracleV2Interface oo = OptimisticOracleV2Interface(0x255483434aba5a75dc60c1391bB162BCd9DE2882); // Optimism
    ...
    function makeAssertion(string calldata assertion) public {
        ...
        IERC20 bondCurrency = IERC20(0x4200000000000000000000000000000000000006); // Optimism Wrapped Native
        uint256 reward = 0;
