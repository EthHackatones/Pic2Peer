...
contract pic2peer {
    ...
    OptimisticOracleV2Interface oo = OptimisticOracleV2Interface(0xd2ecb3afe598b746F8123CaE365a598DA831A449); // Gnosis
    ...
    function makeAssertion(string calldata assertion) public {
        ...
        IERC20 bondCurrency = IERC20(0xe91D153E0b41518A2Ce8Dd3D7944Fa863463a97d); // Gnosis Wrapped Native
        uint256 reward = 0;
