...
contract pic2peer {
    ...
    OptimisticOracleV2Interface oo = OptimisticOracleV2Interface(0xee3afe347d5c74317041e2618c49534daf887c24); // Polygon
    ...
    function makeAssertion(string calldata assertion) public {
        ...
        IERC20 bondCurrency = IERC20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270); // Polygon WETH
        uint256 reward = 0;
